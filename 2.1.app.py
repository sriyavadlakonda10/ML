...
model = pickle.load(open(r"C:\Users\Sriya v\VS CODE\machine learning\SLR1\linear_regression_model.pkl", 'rb'))

# Set the title of the Streamlit app
st.title("Salary Prediction App")

# Add a brief descdcription
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by sriya vadlakonda")
